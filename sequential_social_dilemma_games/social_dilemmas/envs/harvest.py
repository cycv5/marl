...
from marl.sequential_social_dilemma_games.social_dilemmas.envs.agent import HarvestAgent  # HARVEST_VIEW_SIZE
from marl.sequential_social_dilemma_games.social_dilemmas.constants import HARVEST_MAP
...
class HarvestEnv(MapEnv):
    ...
    def observation_space(self):
        if self.return_agent_actions:
            ...
            return Box(low=0, high=15, shape=(2 * self.view_len + 1, 2 * self.view_len + 1, 3), dtype=np.int32)
